...
Starting_FF_file_GOMC = 'required_data/equilb_box_500K/100k/Generate_liq_vap_boxes/GOMC_water_FF.inp'  # from main folder
Starting_FF_file_NAMD = 'required_data/equilb_box_500K/100k/Generate_liq_vap_boxes/NAMD_water_FF.inp'  # from main folder
# box 0 data
Starting_PDB_box_0_file = 'required_data/equilb_box_500K/100k/Generate_liq_vap_boxes/Box_0_liq_water_box.pdb' # from main folder

Starting_PSF_box_0_file = 'required_data/equilb_box_500K/100k/Generate_liq_vap_boxes/Box_0_liq_water_box.psf' # from main folder

# box 1 data
Starting_PDB_box_1_file = '' # from main folder
Starting_PSF_box_1_file = '' # from main folder
