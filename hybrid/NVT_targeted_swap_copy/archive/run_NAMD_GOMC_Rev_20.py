...
Starting_FF_file_GOMC = 'required_data/build_liq_vap_boxes/GOMC_pore_water_rigid_FF.inp'  # from main folder
Starting_FF_file_NAMD = 'required_data/build_liq_vap_boxes/NAMD_pore_water_FF.inp'  # from main folder
# box 0 data
