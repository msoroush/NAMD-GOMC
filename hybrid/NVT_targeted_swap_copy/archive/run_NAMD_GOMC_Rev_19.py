...
Total_cycles_NAMD_GOMC_sims = 400000 # 400000 # enter integer: # simulations NAMD + GOMC sims = 2 * Total_cycles_NAMD_GOMC_sims
...
only_use_box_0_for_NAMD_for_GEMC = False    # bool, True or False.  True = NAMD runs only box 0 for GEMC, False = NAMD runs box 0 and 1 for GEMC
No_core_box_0 =  2  # CPU cores: this is the ONLY place to enter CPU cores for 'GCMC', 'NPT', 'NVT', and  'GEMC' and only_use_box_0_for_NAMD_for_GEMC = True
...
GCMC_only_ChemPot_Type_1_mu_K = -4000  # float: GCMC ONLY!!! -- GOMC units of mu (chemical potential ) are in units of K, must have Type_1 for GCMC
...
GOMC_Run_Steps = 5000  # needs to be 10 minimum for now, NEEDS TO BE THE SAME AS THE PREVIOUS SIMULATION, IF RESTARTED!
NAMD_Run_Steps = 5000   # needs to be 10 minimum for now, NEEDS TO BE THE SAME AS THE PREVIOUS SIMULATION, IF RESTARTED!
...
Starting_FF_file_GOMC = 'required_data/equilb_box_298K/NAMD_24ns_Equilb_NVT_water.inp'  # from main folder
